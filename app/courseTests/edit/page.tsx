...
export default function EditTestPage() {
    ...
    useEffect(() => {
        ...
        if (!testId) { router.push('/courseTests'); return; }
    ...
    async function handleSave() {
        ...
        setSaveError(null);
        try {
            const res = await fetch(`/api/courseTests/${testId}`, {
                method: 'PATCH',
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <main className="flex-1 p-6 max-w-3xl">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-semibold text-gray-800">Редактирование теста</h3>
                    </div>
