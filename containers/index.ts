...
export type { EntityRow, EntityType, ManualRow, TrainingRow, TestRow, AdaptationPlanRow, AchievementRow, FunctionalRow, EventRow, VacancyRow, VacancyLeadRow } from './EntityTable/EntityTable';
