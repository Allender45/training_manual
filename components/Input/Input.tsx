...
type InputProps = {
    ...
    maxLength?: number;
    minLength?: number;
    icon?: 'user' | 'email' | 'phone' | 'lock' | 'fileUpload';
    error?: string;
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(function Input(
    ...
    return (
       ...
       file:py-2 file:px-3 file:mr-3 file:rounded-l-lg file:cursor-pointer
       hover:file:bg-gray-200 ${error ? 'border-red-300' : 'border-gray-300'}`
